...
FUNDS = {
    ...
    "psf": {
        ...
        "spy_inc": 751.41,
        "holdings": [
            {"ticker": "RKLB", "name": "Rocket Lab",            "weight": 22, "bucket": "Launch & Systems",     "inc": 144.475},
            {"ticker": "ASTS", "name": "AST SpaceMobile",       "weight": 16, "bucket": "Direct-to-Cell",       "inc": 126.60},
            {"ticker": "PL",   "name": "Planet Labs",           "weight": 10, "bucket": "Earth Observation",    "inc": 50.638835},
            {"ticker": "VSAT", "name": "Viasat",                "weight": 8,  "bucket": "SatComms",             "inc": 81.66},
            {"ticker": "IRDM", "name": "Iridium Communications","weight": 8,  "bucket": "SatComms",             "inc": 50.25},
            {"ticker": "HEI",  "name": "HEICO",                 "weight": 8,  "bucket": "Aerospace Components", "inc": 308.86},
            {"ticker": "HWM",  "name": "Howmet Aerospace",      "weight": 6,  "bucket": "Aerostructures",       "inc": 261.89},
            {"ticker": "BKSY", "name": "BlackSky Technology",   "weight": 5,  "bucket": "Earth Observation",    "inc": 51.64},
            {"ticker": "SPIR", "name": "Spire Global",          "weight": 5,  "bucket": "Space Data",           "inc": 24.74},
            {"ticker": "HXL",  "name": "Hexcel",                "weight": 4,  "bucket": "Composite Materials",  "inc": 87.96},
            {"ticker": "MRCY", "name": "Mercury Systems",       "weight": 4,  "bucket": "Space Electronics",    "inc": 99.32},
            {"ticker": "MNTS", "name": "Momentus",              "weight": 4,  "bucket": "In-Space Logistics",   "inc": 12.8899},
        ],
        "news": [
            ...
            {"ticker": "HEI",  "headline": "HEICO Closes Acquisition #98 — Specialty Connector Bolt-On",     "summary": "HEICO completed its 98th acquisition under the Mendelson family — a specialty aerospace connector business. Maintains 20+ year compounding playbook with high ROIC discipline.",                                                       "sentiment": "positive", "date": "2026-05-19"},
            {"ticker": "HWM",  "headline": "Howmet Reports Record Fastener Backlog — SpaceX Volume Up 3x",   "summary": "Howmet disclosed record fastener backlog driven by commercial aerospace recovery and a 3x jump in SpaceX titanium part volumes year-over-year.",                                                                                          "sentiment": "positive", "date": "2026-05-16"},
            {"ticker": "HXL",  "headline": "Hexcel Secures Multi-Year Composite Supply for Starship Program","summary": "Hexcel signed a multi-year supply agreement for carbon composite materials used in Starship secondary structures and heat-shield substrate.",                                                                                            "sentiment": "positive", "date": "2026-05-13"},
            {"ticker": "MRCY", "headline": "Mercury Wins $145M Rad-Hard Space Processor Contract",           "summary": "Mercury Systems awarded a $145M Space Force contract for radiation-hardened processing modules. Sub-systems will fly on next-gen GPS and missile-warning satellites.",                                                                "sentiment": "positive", "date": "2026-05-09"},
        ],
        "changes": [
            "Rebalanced 2026-05-26: added supply chain (HEI, HWM, HXL, MRCY) to reduce pre-revenue concentration.",
            "RKLB 22%: Pure-play SpaceX comp — vertically integrated launch + space systems. Neutron rocket due late 2026.",
            "ASTS 16%: Direct-to-cellphone satellite with AT&T/Verizon/Vodafone/Rakuten partnerships.",
            "HEI 8%: 'Picks and shovels' anchor — dominant in aerospace PMA parts. Used in every space program.",
            "HWM 6%: Documented SpaceX supplier — titanium aerostructures and fasteners. Direct cadence beneficiary.",
            "Pre-revenue names (ASTS, BKSY, MNTS, SPIR) trimmed from 43% to 30% total to reduce blowup risk.",
        ],
    },
}
